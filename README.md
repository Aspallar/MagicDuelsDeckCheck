...
Download the DeckCheckSetup.msi file from [here](https://github.com/Aspallar/MagicDuelsDeckCheck/releases/tag/v1.11.1) and run it. This will install MagicDuelsDeckCheck and add a shortcut to your start menu.
...
See [Text File Format](https://github.com/Aspallar/MagicDuelsDeckCheck/wiki/Text-File-Format) for more details.
