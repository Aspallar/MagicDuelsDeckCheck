...
{
    internal static class PageTemplateFields
    {
    ...
    {
        public const string DeckName = "[deckname]";
        public const string CardTotal = "[cardtotal]";
        public const string DeckUrl = "[deckurl]";
    ...
    internal static class ItemTemplateFields
    {
        ...
        public const string UrlCardName = "[urlcardname]";
        public const string WikiCardName = "[wikicardname]";
